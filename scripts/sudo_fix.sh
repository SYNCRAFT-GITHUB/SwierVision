...
# IDEXScreen sudo fix. Modified from moonraker-sudo
...
SUDOERS_FILE='021-sudo-for-idexscreen'
NEW_GROUP='idexscreensudo'
...
Cmnd_Alias SYSTEMCTL_KS_RESTART = /bin/systemctl restart IDEXScreen
