# Network in SwierVision is a connection in NetworkManager
# Interface in SwierVision is a device in NetworkManager
...
from sv_includes.wifi import WifiChannels
from sv_includes import NetworkManager
