...
from sv_includes.KlippyGtk import find_widget
...
class Panel(ScreenPanel):
    ...
    def create_buttons(self):
        ...
        self.buttons = {
            ...
            'calibrate': self._gtk.Button("calibrate", _("Calibrate"), "color4"),
        ...
        self.buttons['calibrate'].connect("clicked", self.menu_item_clicked, {
            "panel": "gcode_offset", "name": _("Calibrate")})
    ...
    def show_buttons_for_state(self):
        ...
        if self.state == "printing":
            ...
            self.buttons['button_grid'].attach(self.buttons['calibrate'], 3, 0, 1, 1)
    ...
    def update_filename(self, filename):
        ...
        self.labels["file"].set_label(self.beauty(os.path.splitext(self.filename)[0]))
        self.filename_label = {
